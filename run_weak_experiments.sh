...
for x in {79,100,126,159,200,252}
do
	...
	filename=":WEAK-MINICOMBUST_RANKS$MINICOMBUST_RANKS-MINICOMBUST_GPUS$MINICOMBUST_GPUS-MINICOMBUST_CELLS$MINICOMBUST_CELLS-MINICOMBUST_PARTICLES-$MINICOMBUST_PARTICLES-MINICOMBUST_ITERS$MINICOMBUST_ITERS.log"
	echo "$cmd"
	echo "$filename"
