...
do
	...
	filename="STRONG-MINICOMBUST_RANKS$MINICOMBUST_RANKS-MINICOMBUST_GPUS$MINICOMBUST_GPUS-MINICOMBUST_CELLS$MINICOMBUST_CELLS-MINICOMBUST_PARTICLES-$MINICOMBUST_PARTICLES-MINICOMBUST_ITERS$MINICOMBUST_ITERS.log"
	echo "$cmd"
	# echo "$filename"
