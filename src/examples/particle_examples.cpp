...
{
    vec<double> position = {1.0, 1.0, 1.0};
    vec<double> velocity = {0.1, 0.1, 0.1};
    vec<double> acceleration = {0.1, 0.1, 0.1};
    ...
    ParticleDistribution<double> *particle_dist = new ParticleDistribution<double>(particles_per_timestep, position, rate, xy_angle, angle_rotation, velocity,
