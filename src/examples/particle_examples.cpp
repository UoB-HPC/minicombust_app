...
ParticleDistribution<double> *load_particle_distribution(uint64_t particles_per_timestep, uint64_t remainder_particles, MPI_Config *mpi_config, Mesh<double> *mesh)
{
    ...
    ParticleDistribution<double> *particle_dist = new ParticleDistribution<double>(particles_per_timestep, remainder_particles, mpi_config, mesh, position, rate, xy_angle, angle_rotation, velocity,
