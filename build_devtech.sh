...
make CUDA_INSTALL_PATH=/usr/local/cuda/ AMGX_INSTALL_PATH=/lustre/fsw/coreai_devtech_all/hwaugh/repos//AMGX/install/ MPI_INSTALL_PATH=/usr/local/openmpi/ clean gpu
